...
#ifndef ML_PF_FF_MAC_SCHEDULER_H
#define ML_PF_FF_MAC_SCHEDULER_H
...
/// mlPfsFlowPerf_t structure
struct mlPfsFlowPerf_t
{
  ...
  double achievableRate;  ///< last throughput
...
class MlPfFfMacScheduler : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
  ...
  /// allow MemberCschedSapProvider<MlPfFfMacScheduler> class friend access
  friend class MemberCschedSapProvider<MlPfFfMacScheduler>;
  /// allow MemberSchedSapProvider<MlPfFfMacScheduler> class friend access  
  friend class MemberSchedSapProvider<MlPfFfMacScheduler>;
...
private:
  ...
  */
  std::map <uint16_t, mlPfsFlowPerf_t> m_flowStatsDl;

  /**
  * Map of UE statistics (per RNTI basis)
  */
  std::map <uint16_t, mlPfsFlowPerf_t> m_flowStatsUl;
  ...
  */
  ...
  uint64_t GetImsiMod (uint16_t rnti);
  ...
  */
  ...
  std::map <uint16_t, uint64_t> m_rntiToImsiMap;
  uint16_t m_cellId;
  bool m_measurementActive = false;

  TracedCallback<double, uint64_t, bool> m_rateMeasurement;
  typedef void (*RateMeasurementTracedCallback)(double Rate,
                                             uint64_t imsi, bool dl);
};

} // namespace ns3

#endif /* ML_PF_FF_MAC_SCHEDULER_H */
