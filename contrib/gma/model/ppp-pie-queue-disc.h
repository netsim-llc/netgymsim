...
#ifndef PPP_PIE_QUEUE_DISC_H
#define PPP_PIE_QUEUE_DISC_H
...
class PppPieQueueDiscTestCase;  // Forward declaration for unit test
namespace ns3 {
 ...
 */
class PppPieQueueDisc : public QueueDisc
{
public:
  /**
  ...
  /**
   * \brief PppPieQueueDisc Constructor
   */
  PppPieQueueDisc ();

  /**
   * \brief PppPieQueueDisc Destructor
   */
  virtual ~PppPieQueueDisc ();
...
private:
  friend class::PppPieQueueDiscTestCase;         // Test code
  ...
  bool DropEarlyPpp (Ptr<QueueDiscItem> item, uint32_t qSize);
  ...
  static const uint8_t m_level = 16; //the level of priority
};
