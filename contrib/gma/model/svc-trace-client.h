...
#ifndef SVC_TRACE_CLIENT_H
#define SVC_TRACE_CLIENT_H
 ...
 */
class SvcTraceClient : public Application
{
public:
  /**
   ...
   *
   */
  SvcTraceClient (Ipv4Address ip, uint16_t port, char *traceFile);
  ~SvcTraceClient ();
