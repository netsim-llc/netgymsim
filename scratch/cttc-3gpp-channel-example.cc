...
// position the base stations
    ...
    else
    {
        ...
        ueNodes.Get(2)->GetObject<MobilityModel>()->SetPosition(Vector(80, 15, hUT));
        ueNodes.Get(2)->GetObject<ConstantVelocityMobilityModel>()->SetVelocity(Vector(0, 0, 0));

        ueNodes.Get(3)->GetObject<MobilityModel>()->SetPosition(Vector(20, 50.0, hUT));
