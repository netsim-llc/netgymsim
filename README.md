...
9. Run the example script for multi-access (or networkslicing )
  ```
  cd network_gym_sim
  ./ns3 run sccratch/unified-network-slicing --cwd "path-to-netgymsim/netgymsim/test/multi-access (or networkslicing)"
  ```
